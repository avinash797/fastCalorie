...
export const GET = withAuth(async (_request, _admin, context) => {
  try {
...
export const PUT = withAuth(async (request, admin, context) => {
  try {
    const { id } = await context!.params;
...
export const DELETE = withAuth(async (_request, admin, context) => {
  try {
    const { id } = await context!.params;
